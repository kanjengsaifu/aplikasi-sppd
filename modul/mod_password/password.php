	...
	if ($_GET['aksi']=="ganti"){
		if ($_POST['passwordbaru']==$_POST['cpassword']) {
			...
			if ($_POST['passwordlama']==$passwordlama) {
				...
				echo "<div id=\"info1\">Password Anda Berhasil Di Ubah</div>";
			}
			else{
		...
		<tr><td>Masukkan Password Lama 			</td><td><input type='password' name='passwordlama'  style=\"background-color: #333333\"></td></tr>
		<tr><td>Masukkan Password Baru			</td><td> <input type='password' name='passwordbaru' id='passwordbaru'  style=\"background-color: #333333\"></td></tr>
		<tr><td>Ulangi Password Baru  		</td><td><input type='password' name='cpassword' id='cpassword'  style=\"background-color: #333333\"></td></tr>
